...
impl LayeredField {
    ...
    /// Build a field from a complete row-major cell buffer and sampling evidence.
    ///
    /// The constructor rejects empty, overflowing, or length-mismatched storage;
    /// callers cannot construct a partially initialized field.
    pub fn from_cells(
        width: usize,
        height: usize,
        cells: Vec<LayeredCell>,
