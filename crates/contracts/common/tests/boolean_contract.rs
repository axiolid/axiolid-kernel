...
use axiolid_kernel::{
    ...
    CancellationGranularity, CancellationToken, ExecutionOptions, ExecutionTarget, GeomError,
    GeomResult, MeshBoolean, MeshBooleanRegistry, ScratchRequirement, SolidRequirements,
};
