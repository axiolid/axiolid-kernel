...
use axiolid_kernel::{
    ...
    ExecutionTarget, GeomError, GeomResult, MeshPlaneSection, MeshPlaneSectionRegistry,
    ScratchRequirement, SectionContour, SectionEvidence, SectionLimits, SectionOutcome,
};
