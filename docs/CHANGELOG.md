...
- Added bounded planar clamped curve/curve root isolation with exact-sign line/point classification, outward-rounded rational derivative bounds, strict-interior Krawczyk proofs for transverse roots, explicit native-parameter resolution contracts, localized structural overlap/tangency outcomes, hard allocation-safe work ceilings, and explicit unresolved singular or boundary boxes; see [ADR 0026](./adr/0026-certified-planar-nurbs-root-isolation.md).
