...
- Added bounded planar clamped curve/curve root isolation with exact-sign line classification, outward-rounded rational derivative bounds, strict-interior Krawczyk proofs for transverse roots, explicit native-parameter resolution contracts, narrow structural overlap/tangency outcomes, and explicit unresolved singular or boundary boxes; see [ADR 0026](./adr/0026-certified-planar-nurbs-root-isolation.md).
